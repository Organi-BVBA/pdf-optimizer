...
<template>
  <div>
          ...
          <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <label class="flex items-center">
                <Checkbox v-model:checked="createApiTokenForm.permissions"
                          :value="permission"
                />
    ...
    <DialogModal :show="managingPermissionsFor != null"
    ...
    >
      ...
      <template #content>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <label class="flex items-center">
              <Checkbox v-model:checked="updateApiTokenForm.permissions"
                        :value="permission"
              />
              <span class="ml-2 text-sm text-gray-600">{{ permission }}</span>
            </label>
